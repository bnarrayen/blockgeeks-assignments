...
contract ERC20 is IERC20 {
  ...
  // Mapping from an address to an integer representing the no. of tokens the user address owns
 
  mapping (address => mapping (address => uint256)) internal _allowed;
  // Nestled mapping: address of the owner of some tokens; the second layer is another account
  // that the owner has authorized the user to spend some amount of their tokens
